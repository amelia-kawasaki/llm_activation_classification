...
```bash
python activation_extraction.py --model_link meta-llama/Llama-2-7b-chat-hf --benign_input_path benign_open_test_1000.csv --attack_input_path jb_open_test_1000.csv --output_dir output --layer_size 32 --hidden_layer_size 4096
```
